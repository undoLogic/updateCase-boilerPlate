...
echo scp ../src/$FILE_TO_UPLOAD $SSH_USER@$SSH_HOST:$TESTING_ABSOLUTE_PATH/$GITHUB_CURRENT_BRANCH/src/$FILE_TO_UPLOAD && echo ""
...
scp ../src/$FILE_TO_UPLOAD $SSH_USER@$SSH_HOST:$TESTING_ABSOLUTE_PATH/$GITHUB_CURRENT_BRANCH/src/$FILE_TO_UPLOAD && echo ""
